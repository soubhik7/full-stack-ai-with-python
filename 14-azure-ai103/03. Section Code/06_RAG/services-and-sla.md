...
## What compensation do I receive if the SLA is not met?
SLA credits are applied to your next invoice:
- Below 99.9% (Standard) or 99.99% (Enterprise): 10% credit
- Below 99.0%: 25% credit
- Below 95.0%: 50% credit
Credits must be claimed within 30 days of the incident via a
support ticket.

## When are scheduled maintenance windows?
Scheduled maintenance occurs on the second Sunday of each month
