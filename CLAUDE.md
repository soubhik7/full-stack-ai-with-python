...
| `14-azure-ai103/` | Udemy course "Azure AI 103" — Azure OpenAI/AI Foundry agents, Azure AI Search + RAG, LangChain/LangGraph, image generation, Content Safety, Azure AI Language, Azure AI Speech, Document Intelligence. Every course `.py` script (`01_responses_api_basics/` … `08_document_intelligence_capstone/`) has a paired teaching notebook, and all Azure credentials/project details/deployment names are centralized in `14-azure-ai103/azure_config.py` — see `14-azure-ai103/README.md` |
